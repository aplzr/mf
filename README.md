...
<!-- Local badges generated by CI into static/: coverage (anybadge from coverage.xml line-rate) & python minimum version (anybadge from pyproject requires-python, shown as MIN+) -->
![Coverage](./static/badge_coverage.svg) ![Python Versions](./static/badge_python.svg)
